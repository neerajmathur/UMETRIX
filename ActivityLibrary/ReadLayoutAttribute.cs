...
{
    public sealed class ReadLayoutAttribute : CodeActivity<Dictionary<String, IList<String>>>
    {
        ...
        protected override Dictionary<String, IList<String>> Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                var layouts = Directory.GetFiles(AppDomain.CurrentDomain.BaseDirectory + @"\APKDecompile\apkcode\res\layout", "*.xml");
                ...
                foreach (var layoutFile in layouts)
	            {
                    ...
                    _attributeList.Add(layoutFile.Replace(AppDomain.CurrentDomain.BaseDirectory + @"\APKDecompile\apkcode\res\layout", ""), attributes);
