  ...
  extends LinearLayout
{
  ...
  public TextInputLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      this.mPasswordToggleEnabled = paramContext.getBoolean(R.styleable.TextInputLayout_passwordToggleEnabled, true);
  ...
  private void updatePasswordToggleView()
  {
    if (shouldShowPasswordIcon())
    {
      ...
      TextViewCompat.setCompoundDrawablesRelative(this.mEditText, arrayOfDrawable[0], arrayOfDrawable[1], this.mPasswordToggleDummyDrawable, arrayOfDrawable[2]);
    ...
    TextViewCompat.setCompoundDrawablesRelative(this.mEditText, arrayOfDrawable[0], arrayOfDrawable[1], null, arrayOfDrawable[2]);
  }
