...
{
  private static final WindowInsetsCompatImpl IMPL = new WindowInsetsCompatBaseImpl(null);
  ...
  static
  {
    ...
    if (i >= 21)
    {
      IMPL = new WindowInsetsCompatApi21Impl(null);
      return;
    }
    if (i >= 20)
    {
      IMPL = new WindowInsetsCompatApi20Impl(null);
      return;
    }
  }
    ...
    extends WindowInsetsCompat.WindowInsetsCompatBaseImpl
  {
    ...
    {
      return new WindowInsetsCompat(WindowInsetsCompatApi20.consumeSystemWindowInsets(paramObject), null);
    }
    ...
    {
      return new WindowInsetsCompat(WindowInsetsCompatApi20.replaceSystemWindowInsets(paramObject, paramInt1, paramInt2, paramInt3, paramInt4), null);
    }
  }
    ...
    extends WindowInsetsCompat.WindowInsetsCompatApi20Impl
  {
    ...
    {
      return new WindowInsetsCompat(WindowInsetsCompatApi21.consumeStableInsets(paramObject), null);
    }
    ...
    {
      return new WindowInsetsCompat(WindowInsetsCompatApi21.replaceSystemWindowInsets(paramObject, paramRect), null);
    }
  }
