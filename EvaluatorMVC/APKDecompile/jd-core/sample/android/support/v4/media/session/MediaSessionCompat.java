...
public class MediaSessionCompat
{
    ...
    implements MediaSessionCompat.MediaSessionImpl
  {
      ...
      extends IMediaSession.Stub
    {
      ...
      {
        MediaSessionCompat.MediaSessionImplBase.this.postToHandler(1, new MediaSessionCompat.MediaSessionImplBase.Command(paramString, paramBundle, MediaSessionCompat.ResultReceiverWrapper.access$1000(paramResultReceiverWrapper)));
      }
