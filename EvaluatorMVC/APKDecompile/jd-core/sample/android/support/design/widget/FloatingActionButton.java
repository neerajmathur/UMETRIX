  ...
  extends VisibilityAwareImageButton
{
  ...
  private FloatingActionButtonImpl createImpl()
  {
    ...
    if (i >= 21) {
      return new FloatingActionButtonLollipop(this, new ShadowDelegateImpl(null), ViewUtils.DEFAULT_ANIMATOR_CREATOR);
    }
    if (i >= 14) {
      return new FloatingActionButtonIcs(this, new ShadowDelegateImpl(null), ViewUtils.DEFAULT_ANIMATOR_CREATOR);
    }
    return new FloatingActionButtonGingerbread(this, new ShadowDelegateImpl(null), ViewUtils.DEFAULT_ANIMATOR_CREATOR);
  }
    ...
    extends CoordinatorLayout.Behavior<FloatingActionButton>
  {
    ...
    private static boolean isBottomSheet(View paramView)
    {
      ...
      return (paramView != null) && ((paramView.getBehavior() instanceof BottomSheetBehavior));
    }
