  ...
  extends FrameLayout
{
  ...
  {
    return (this.mToolbarDrawIndex >= 0) && (this.mToolbarDrawIndex == indexOfChild(paramView) + 1);
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((this.mCollapsingTitleEnabled) && (this.mDummyView != null))
    {
      ...
      if (this.mDrawCollapsingTitle)
      {
        ...
        label313:
        k = this.mExpandedMarginTop;
        if (i == 0) {
          break label499;
        }
        i = this.mExpandedMarginStart;
        label330:
        ((CollapsingTextHelper)localObject).setExpandedBounds(j, k, paramInt3 - paramInt1 - i, paramInt4 - paramInt2 - this.mExpandedMarginBottom);
